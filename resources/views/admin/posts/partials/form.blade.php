<div class="box-body">
        ...
        <div class="col-sm-10">
            <div class="form-group multiple_box">
                <?php
                    $defaultCategories = [];
                    if(isset($post)) {
                        $defaultCategories = $post->categories->pluck('id')->all();
                    }
                ?>
    ...
    <!-- <div class="form-group">
        ...
        <label for="inputDisplayOrder" class="col-sm-2 control-label">Start Date</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class='input-group date' id='EndDate'>
                {{ Form::text('end_date', \Request::old('end_date'), ['class' => 'form-control', 'placeholder' => 'End Date']) }}
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <div class="checkbox">
                <label>
                    {{ Form::checkbox('is_featured', \Request::old('is_featured'), null) }} is Featured
                </label>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <div class="checkbox">
                <label>
                    {{ Form::checkbox('show_on_banner', \Request::old('show_on_banner'), null) }} Show on Banner
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::file('image', ['class' => 'form-control', 'id' => 'inputImage', 'placeholder' => 'Image']) }}
            @if($errors->has('image'))
